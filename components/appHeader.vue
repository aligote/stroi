        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12 d-center">
            <div class="header-top-left">
              <img src="@/assets/img/icon/call.png" alt="">Call Us : +11 222 3333
            </div>
          </div>
          <!-- Header Top left End -->
          <!-- Search Box Start -->
                  ...
                  <ul class="ht-dropdown main-cart-box">
                    <li>
                      ...
                      <div class="single-cart-box">
                        <div class="cart-img">
                          <a href="#"><img src="@/assets/img/menu/1.jpg" alt="cart-image"></a>
                        </div>
                      ...
                      <div class="single-cart-box">
                        <div class="cart-img">
                          <a href="#"><img src="@/assets/img/menu/2.jpg" alt="cart-image"></a>
                        </div>
                        <div class="cart-content">
                          <h6><a href="product.html">Products Name</a></h6>
                          <span>2 × $299.00</span>
